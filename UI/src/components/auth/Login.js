        ...
        <div className="col-lg-12 col-resp">
          <div className="login-box box-wrapper-head">
            <div className="logo logo-top">
                <Link to="/"><img className="fix-img" src="assets/images/logo.png"/></Link>
            </div>
            ...
            <div className="form-wrapper">
                <div className="form-container-box">
                    <form className="form" onSubmit={e => onSubmit(e)} >
                        ...
                        <button type="submit" className="btn btn-primary btn-lg btn-block btn-login-custom" >Log In</button>
                    </form>
                    <div className="forget-password-text forget-pass-link" >
                        <span><a className="forget-link" href="#" onClick={() => handleForgetPasswordShow() }>Forget Password</a></span>
                    </div>
                    <button className="btn btn-success btn-lg active btn-signup-custom" onClick={() => handleShow()}>Sign Up</button>
                    <div className="mt-3">
                        <Alert />
                    </div>
                </div>
          ...
          <div className="login-form-image">
              <img src="assets/images/image_4.png" className="img4 login-image img-responsive" />
          </div>
          </div>
        </div>
        </div>
        <Register showRegister={showRegister} handleClose={handleClose} />
        <ForgetPassword showForgetPassword={showForgetPassword} handleForgetPasswordClose={handleForgetPasswordClose} />
    </Fragment>
  );
};
