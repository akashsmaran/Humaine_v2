                ...
                <div className="col-lg-12 col-resp">
                    <div className="login-box box-wrapper-head">
                        <div className="logo logo-top">
                            <Link to="/"><img src="http://localhost:3000/assets/images/logo.png" /></Link>
                        </div>
                        ...
                        <div className="form-wrapper">
                            <div className="form-container-box">
                                ...
                                <form className="form" onSubmit={e => onSubmit(e)} >
                                    ...
                                    <button type="submit" className="btn btn-primary btn-lg btn-block btn-login-custom" >Change Password</button>
                                </form>
                                <div className="mt-3">
                                    <Alert />
                                </div>
                        ...
                        <div className="login-form-image">
                            <img src="http://localhost:3000/assets/images/image_4.png" className="img4 login-image img-responsive" />
                        </div>
                    </div>
                </div>
            </div>
