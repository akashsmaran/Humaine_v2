...
const Dashboard = ({ getCases, auth: { user }, loading, case: { cases, casesLoading } }) => {
                        ...
                        <div className="row card-wrapper-whole">
                            <div className="col-md-6 col-lg-4 col-xl-3 container-body no-padding">
                                ...
                                <div className="card-mini card-grey-bg">
                                    ...
                                    <div className="div-training-desc">Lean how to use Humaine's simulator!</div>

                                    <div className="div-training-img">
                                        <img className="div-training-pic" src="http://localhost:3000/assets/images/play.png" alt="rover" />
                                    </div>
                                </div>
                            ...
                            {cases.map(function (caseItem, i) {
                                ...
                                if (caseItem.case_difficulty == 'Moderate') {
                                    tagClass = 'lbl-hard';
                                } else if (caseItem.case_difficulty == 'Difficult') {
                                    tagClass = 'lbl-medium';
                                } else {
                                    tagClass = 'lbl-easy';
                                }
                                ...
                                return (
                                    <div className="col-md-6 col-lg-4 col-xl-3 container-body no-padding" key={caseItem.id}>

                                        <div className={"card " + colorClass}>
                                            <div className={"status-label " + tagClass}>{caseItem.case_difficulty}</div>
                                            <div className="card-header-fit">
                                                <img src="http://localhost:3000/assets/images/user2.jpeg" alt="rover" />
                                            </div>
                                            <div className="card-body">
                                                <div className="main-card-head">{caseItem.case_name}</div>
                                                <Link to={"/cases/support/" + caseItem.id}>
                                                    <div className="card-heading-text">
                                                        <span className="tag tag-teal mb-5">{caseItem.case_department}</span>
                                            ...
                                            <div className="card-body-bottom">
                                                <div className="btm-image">
                                                    <img src="http://localhost:3000/assets/images/play.png" className="play-btn-resp" alt="rover" />
                                                </div>
...
export default connect(mapStateToProps, { getCases })(
    Dashboard
);
